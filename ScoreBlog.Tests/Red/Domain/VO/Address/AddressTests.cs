namespace ScoreBlog.Tests.Red.Domain.VO.Address;
...
public class AddressTests
{
    ...
    {
        var address = new ScoreBlog.Domain.ValueObjects.Address(-1, "", null, "This is a very long complement that exceeds 100 characters, which should make the validation fail because the complement is too long.");
